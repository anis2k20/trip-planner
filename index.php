...
<body class="bg-gray-100">
    ...
    <header
        ...
        <ul class="flex font-poppins font-semibold justify-between gap-10 text-black">
            ...
            <li><a href="./upcomming-trip.html" class="duration-300 hover:underline">Show Upcoming Trips</a></li>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Emplyee Information System</title>
...
<body>
    ...
    <div class="container">
    <h1 >Emplyee Information System</h1>
        <form action="#" method="POST">
            <label for="name">
                Emplyee:
                <input type="text" name="name" id="textfield" placeholder="Enter Name">
            </label>

            <label for="email">
                Email:
                <input type="email" name="email" id="textfield" placeholder="Enter Email">
            </label>

            <label for="gander">
                Gender:
                <select name="gander" id="textfield">
            ...
            <label for="department">
                Department:
                <select name="department" id="textfield">
            ...
            <label for="slaray">
                Salary:
                <input type="number" name="slaray" id="textfield">
            </label>

            <label for="address" id="textfield">
                Address:
                <textarea name="address" id="textfield" cols="30" rows="5"></textarea>
            </label>
            <input type="submit" name="Save" id="textfield">
        </form>

        <a href="empInfo.php">Show Data</a>
    </div>
</body>
</html> -->